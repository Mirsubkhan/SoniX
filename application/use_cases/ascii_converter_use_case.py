...
class ASCIIConverterUseCase:
    def __init__(self, converter: ArtConverter, file_handler: FileHandlerUseCase):
    ...
    async def convert(self, f_input: FileInputDTO, char_width: int=300) -> FileOutputDTO:
        ...
        output_img = await self.converter.image_to_ascii(image=image, char_width=char_width)
